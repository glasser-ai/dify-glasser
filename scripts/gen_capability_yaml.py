...
TOOLS = {
    "people_search": dict(
        ...
        human=L("B2B people data from Apollo, People Data Labs, Hunter, Prospeo, LeadMagic and ZoomInfo via Glasser — search contacts by title, seniority, location or employer, enrich one person's profile, find a work email. For building target lists and reaching decision makers.",
                "由 Glasser 提供的 Apollo、People Data Labs、Hunter、Prospeo、LeadMagic 与 ZoomInfo B2B 人物数据——按职位、级别、地区或雇主搜索联系人，补全一个人的资料，查找工作邮箱。适用于建立目标客户名单与找到决策者。",
                "Glasser経由のApollo、People Data Labs、Hunter、Prospeo、LeadMagic、ZoomInfoによるB2B人物データ——役職・レベル・所在地・雇用主で連絡先を検索、1人のプロフィールを補完、仕事用メールを検索。ターゲットリスト作成と意思決定者へのアプローチに。",
                "Dados de pessoas B2B da Apollo, People Data Labs, Hunter, Prospeo, LeadMagic e ZoomInfo via Glasser — pesquise contatos por cargo, senioridade, localização ou empregador, enriqueça o perfil de uma pessoa, encontre um e-mail de trabalho. Para montar listas-alvo e chegar aos decisores."),
    ...
    "company_intelligence": dict(
        ...
        human=L("Company data from Apollo, People Data Labs, Hunter, PredictLeads, BuiltWith, DataForSEO and Ahrefs via Glasser — from a domain, get the company profile and firmographics, technology stack, website traffic, competitors, funding rounds and news. For account research, competitive analysis and sales preparation.",
                "由 Glasser 提供的 Apollo、People Data Labs、Hunter、PredictLeads、BuiltWith、DataForSEO 与 Ahrefs 公司数据——按域名获取公司档案与画像、技术栈、网站流量、竞争对手、融资与新闻。适用于目标客户研究、竞品分析与销售准备。",
                "Glasser経由のApollo、People Data Labs、Hunter、PredictLeads、BuiltWith、DataForSEO、Ahrefsによる企業データ——ドメインから企業プロフィールと属性、技術スタック、サイトトラフィック、競合、資金調達、ニュースを取得。アカウント調査、競合分析、営業準備に。",
                "Dados de empresas da Apollo, People Data Labs, Hunter, PredictLeads, BuiltWith, DataForSEO e Ahrefs via Glasser — a partir de um domínio, obtenha perfil e firmografia, stack de tecnologia, tráfego do site, concorrentes, rodadas de investimento e notícias. Para pesquisa de contas, análise competitiva e preparação de vendas."),
    ...
    "seo_research": dict(
        ...
        human=L("SEO data from Semrush, DataForSEO, Ahrefs and Serpstat via Glasser — keyword volume and difficulty, keyword ideas, a domain's organic traffic and ranking keywords, backlinks and referring domains, domain rating, Google results. For content strategy, SEO audits and competitor keyword analysis.",
                "由 Glasser 提供的 Semrush、DataForSEO、Ahrefs 与 Serpstat SEO 数据——关键词搜索量与难度、关键词拓展、域名自然流量与排名关键词、外链与引荐域名、域名评分、Google 结果。适用于内容策略、SEO 审计与竞品关键词分析。",
                "Glasser経由のSemrush、DataForSEO、Ahrefs、SerpstatによるSEOデータ——キーワードのボリュームと難易度、キーワード候補、ドメインのオーガニックトラフィックとランキングキーワード、被リンクと参照ドメイン、ドメインレーティング、Google結果。コンテンツ戦略、SEO監査、競合キーワード分析に。",
                "Dados de SEO da Semrush, DataForSEO, Ahrefs e Serpstat via Glasser — volume e dificuldade de palavras-chave, ideias de palavras-chave, tráfego orgânico e palavras-chave de um domínio, backlinks e domínios de referência, domain rating, resultados do Google. Para estratégia de conteúdo, auditorias de SEO e análise de palavras-chave da concorrência."),
    ...
    "web_research": dict(
        ...
        human=L("Live web research from Serper, SerpApi and Exa via Glasser — Google web, news, places, scholar, shopping, image and video search, read a web page, neural search and answers with sources. For market research, competitive analysis and fact-checking.",
                "由 Glasser 提供的 Serper、SerpApi 与 Exa 实时网络研究——Google 网页、新闻、地点、学术、商品、图片与视频搜索，读取网页正文，语义搜索与带来源的问答。适用于市场研究、竞品分析与资料核实。",
                "Glasser経由のSerper、SerpApi、Exaによるリアルタイムウェブリサーチ——Googleのウェブ、ニュース、場所、学術、ショッピング、画像、動画検索、ウェブページの読み取り、ニューラル検索と出典付き回答。市場調査、競合分析、ファクトチェックに。",
                "Pesquisa na web em tempo real da Serper, SerpApi e Exa via Glasser — busca web, notícias, lugares, acadêmica, compras, imagens e vídeos do Google, leitura de páginas, busca neural e respostas com fontes. Para pesquisa de mercado, análise competitiva e verificação de fatos."),
    ...
    "social_research": dict(
        label=L("Social Listening", "社交聆听", "ソーシャルリスニング", "Escuta social"),
        human=L("Social data from ScrapeCreators, Apify and TikHub via Glasser — search posts and discussions across Reddit, X, YouTube, TikTok, Instagram and LinkedIn, read profiles and channels, find someone's social accounts. Read-only. For brand monitoring, topic research and creator discovery.",
                "由 Glasser 提供的 ScrapeCreators、Apify 与 TikHub 社交数据——跨 Reddit、X、YouTube、TikTok、Instagram 与 LinkedIn 搜索帖子与讨论，读取主页与频道，查找某人的社交账号。只读。适用于品牌监测、话题研究与创作者发现。",
                "Glasser経由のScrapeCreators、Apify、TikHubによるソーシャルデータ——Reddit、X、YouTube、TikTok、Instagram、LinkedInの投稿と議論を検索、プロフィールとチャンネルを取得、SNSアカウントを検索。読み取り専用。ブランドモニタリング、トピック調査、クリエイター発掘に。",
                "Dados sociais da ScrapeCreators, Apify e TikHub via Glasser — pesquise posts e discussões no Reddit, X, YouTube, TikTok, Instagram e LinkedIn, leia perfis e canais, encontre as contas sociais de alguém. Somente leitura. Para monitoramento de marca, pesquisa de temas e descoberta de criadores."),
